...
opts.remOUT = 1;
opts.remOUTmethod = 'grubbs'; %'median' or 'mean' or 'quartiles' or 'grubbs' or 'gesd'
opts.remOUTbh = 0;
...
opts.motioncorr = 0.5; %motion parameters with higher correlation than threshold will not be included in the regression
...
% pre-process data and run preliminary analysis
    ...
    [idx, rBOLD] = chopTimeseries(BOLD,WBmask, [160 500]);
    ...
    opts.fpass = [0.001 0.08]; %frequency range for ALFF/fALFF
