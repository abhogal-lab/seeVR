...
% <funcToMNI: uses elastix to register a functional image to an anatomical image >
%
...
name2 = fullfile(opts.affine_dir,'func2struct.nii.gz');
movefile(name1, name2)

disp('registration of func to struct complete')
disp(['transformation file saved as: ',fullfile(opts.affine_dir,'TransformParameters.0.txt')])
disp(['image saved as: ',name2])
