...
function [HRFidx, HRF_probe] = convHRF(probe, opts)
% convHRF2
...
%
% Backwards-compatible with prior usage:
% - Keeps opts.onset (gamma shape), opts.disp (exponential decay in *samples*),
%   opts.rratio (inverse undershoot scaling), opts.pad/opts.padfront, opts.detrendHRF, opts.verbose.
% - No global opts. No licols. No toolbox gampdf.
...
opts = setDefault(opts, 'onset',            1);          % gamma shape(s) for main & undershoot (as in your code)
